...
Next we evaluate on a split removes any systems which were in either the PDBbind general set v.2017 or the Crossdock2020 dataset; this fully removes any of the protein-ligand systems which were in the training sets of any of the CNN models. The CNN models see another docking performance decrease when looking at the top pose in comparison to the full datasets, (Figure~\ref{fig:No2017NoCD20}). When we consider the cumulative results for all of the output poses, the performance of the CNNs is unaffected by this subset of the data.
